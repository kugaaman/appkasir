...
$sql="SELECT penjual.*,pelanggan.NamaPelanggan FROM penjual,pelanggan WHERE penjual.PelangganID=pelanggan.PelangganID AND TanggalPenjual BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY penjual.TanggalPenjual ASC";

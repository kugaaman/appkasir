...
$sql="SELECT detailpenjual.*,penjual.TanggalPenjual,produk.NamaProduk FROM detailpenjual,penjual,produk WHERE detailpenjual.PenjualID=penjual.PenjualID AND detailpenjual.ProdukID=produk.ProdukID AND TanggalPenjual BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND detailpenjual.ProdukID=$ProdukID ORDER BY produk.NamaProduk ASC";
...
while($data=mysqli_fetch_array($query)){
    ...
    <tr>
        <td>'.$no.'</td>
        <td>'.$data['PenjualID'].'</td>
        <td>'.$data['TanggalPenjual'].'</td>

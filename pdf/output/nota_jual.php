...
<table style="width:100%">
    <tr>
        ...
        <td style="width:25%">: ' . $penjual['PenjualID'] . '</td>
        <td style="width:25%">Tanggal Transaksi</td>
        <td style="width:25%">: ' . $penjual['TanggalPenjual'] . '</td>
    </tr>
    <tr>
        <td style="width:25%">Nama Pelanggan</td>
        <td style="width:25%">: ' . $penjual['NamaPelanggan'] . '</td>
        <td style="width:25%">Total Belanja</td>
        <td style="width:25%">: Rp.' . number_format($penjual['TotalHarga']) . '</td>
    </tr>
</table>
